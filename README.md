...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bk4n1lk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bk4n1lk.containers.anotherwebservice.com/
...
```
git clone git@github.com:rodrigoesteves45/container-bk4n1lk.git
cd container-bk4n1lk
```
...
```
docker attach container-bk4n1lk
```
